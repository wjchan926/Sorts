 ...
 * The first section demonstrate that the various sorts work. The second section
 * is for gathering the time data for ever sort complete. There are 75 total
 * time data runs.
 * 
 * @author Wesley Chan
 *
...
public class SortDriver {
	...
	/**
	 * Method that runs QuickSorts and saves the time data
	 * 
	 * @param inputFileName
	...
	/**
	 * Method that runs QuickSorts with the 50 element cutoff and saves the time
	 * data
	 * 
	 * @param inputFileName
	 *            Input data for sorting
	...
	/**
	 * Method that runs QuickSorts with the 100 element cutoff and saves the
	 * time data
	 * 
	 * @param inputFileName
	 *            Input data for sorting
	...
	/**
	 * Method that runs QuickSorts with the median of 3 cutoff and saves the
	 * time data
	 * 
	 * @param inputFileName
	 *            Input data for sorting
	...
	/**
	 * Method that runs MergeSorts and saves the time data
	 * 
	 * @param inputFileName
	 *            Input data for sorting
	 * @param outputFileName
